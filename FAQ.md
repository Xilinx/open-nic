...
Xilinx provided the original linux open-nic-driver sources, and a DPDK driver has been developed within the community.  The current open-nic-dpdk can be built using the instructions provided at the [open-nic-dpdk repo](https://github.com/Xilinx/open-nic-dpdk). 
