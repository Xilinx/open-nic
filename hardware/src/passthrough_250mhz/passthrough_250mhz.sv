...
module passthrough_250mhz #(
  ...
  output     [NUM_INTF-1:0] m_axis_tx_250mhz_tvalid,
  output [512*NUM_INTF-1:0] m_axis_tx_250mhz_tdata,
  output  [64*NUM_INTF-1:0] m_axis_tx_250mhz_tkeep,
  output     [NUM_INTF-1:0] m_axis_tx_250mhz_tlast,
  output  [16*NUM_INTF-1:0] m_axis_tx_250mhz_tuser_size,
  output  [16*NUM_INTF-1:0] m_axis_tx_250mhz_tuser_src,
  output  [16*NUM_INTF-1:0] m_axis_tx_250mhz_tuser_dst,
  input      [NUM_INTF-1:0] m_axis_tx_250mhz_tready,

  input      [NUM_INTF-1:0] s_axis_rx_250mhz_tvalid,
  input  [512*NUM_INTF-1:0] s_axis_rx_250mhz_tdata,
  input   [64*NUM_INTF-1:0] s_axis_rx_250mhz_tkeep,
  input      [NUM_INTF-1:0] s_axis_rx_250mhz_tlast,
  input   [16*NUM_INTF-1:0] s_axis_rx_250mhz_tuser_size,
  input   [16*NUM_INTF-1:0] s_axis_rx_250mhz_tuser_src,
  input   [16*NUM_INTF-1:0] s_axis_rx_250mhz_tuser_dst,
  output     [NUM_INTF-1:0] s_axis_rx_250mhz_tready,
  ...
  passthrough_250mhz_reset reset_inst (
    .mod_rstn     (mod_rstn),
  ...
  generate for (genvar i = 0; i < NUM_INTF; i++) begin
    ...
    wire [47:0] axis_tx_250mhz_tuser;
    wire [47:0] axis_rx_250mhz_tuser;
    ...
    assign axis_rx_250mhz_tuser[0+:16]  = s_axis_rx_250mhz_tuser_size[`getvec(16, i)];
    assign axis_rx_250mhz_tuser[16+:16] = s_axis_rx_250mhz_tuser_src[`getvec(16, i)];
    assign axis_rx_250mhz_tuser[32+:16] = s_axis_rx_250mhz_tuser_dst[`getvec(16, i)];

    assign m_axis_tx_250mhz_tuser_size[`getvec(16, i)] = axis_tx_250mhz_tuser[0+:16];
    assign m_axis_tx_250mhz_tuser_src[`getvec(16, i)]  = axis_tx_250mhz_tuser[16+:16];
    assign m_axis_tx_250mhz_tuser_dst[`getvec(16, i)]  = 16'h1 << (6 + i);
    ...
    axi_stream_pipeline tx_ppl_inst (
      ...
      .m_axis_tvalid (m_axis_tx_250mhz_tvalid[i]),
      .m_axis_tdata  (m_axis_tx_250mhz_tdata[`getvec(512, i)]),
      .m_axis_tkeep  (m_axis_tx_250mhz_tkeep[`getvec(64, i)]),
      .m_axis_tlast  (m_axis_tx_250mhz_tlast[i]),
      .m_axis_tuser  (axis_tx_250mhz_tuser),
      .m_axis_tready (m_axis_tx_250mhz_tready[i]),
    ...
    axi_stream_pipeline rx_ppl_inst (
      .s_axis_tvalid (s_axis_rx_250mhz_tvalid[i]),
      .s_axis_tdata  (s_axis_rx_250mhz_tdata[`getvec(512, i)]),
      .s_axis_tkeep  (s_axis_rx_250mhz_tkeep[`getvec(64, i)]),
      .s_axis_tlast  (s_axis_rx_250mhz_tlast[i]),
      .s_axis_tuser  (axis_rx_250mhz_tuser),
      .s_axis_tready (s_axis_rx_250mhz_tready[i]),
