...
`endif
    ...
    .s_axis_adap_tx_250mhz_tvalid             (axis_adap_tx_250mhz_tvalid),
    .s_axis_adap_tx_250mhz_tdata              (axis_adap_tx_250mhz_tdata),
    .s_axis_adap_tx_250mhz_tkeep              (axis_adap_tx_250mhz_tkeep),
    .s_axis_adap_tx_250mhz_tlast              (axis_adap_tx_250mhz_tlast),
    .s_axis_adap_tx_250mhz_tuser_size         (axis_adap_tx_250mhz_tuser_size),
    .s_axis_adap_tx_250mhz_tuser_src          (axis_adap_tx_250mhz_tuser_src),
    .s_axis_adap_tx_250mhz_tuser_dst          (axis_adap_tx_250mhz_tuser_dst),
    .s_axis_adap_tx_250mhz_tready             (axis_adap_tx_250mhz_tready),

    .m_axis_adap_rx_250mhz_tvalid             (axis_adap_rx_250mhz_tvalid),
    .m_axis_adap_rx_250mhz_tdata              (axis_adap_rx_250mhz_tdata),
    .m_axis_adap_rx_250mhz_tkeep              (axis_adap_rx_250mhz_tkeep),
    .m_axis_adap_rx_250mhz_tlast              (axis_adap_rx_250mhz_tlast),
    .m_axis_adap_rx_250mhz_tuser_size         (axis_adap_rx_250mhz_tuser_size),
    .m_axis_adap_rx_250mhz_tuser_src          (axis_adap_rx_250mhz_tuser_src),
    .m_axis_adap_rx_250mhz_tuser_dst          (axis_adap_rx_250mhz_tuser_dst),
    .m_axis_adap_rx_250mhz_tready             (axis_adap_rx_250mhz_tready),

    .m_axis_adap_tx_322mhz_tvalid             (axis_adap_tx_322mhz_tvalid),
    .m_axis_adap_tx_322mhz_tdata              (axis_adap_tx_322mhz_tdata),
    .m_axis_adap_tx_322mhz_tkeep              (axis_adap_tx_322mhz_tkeep),
    .m_axis_adap_tx_322mhz_tlast              (axis_adap_tx_322mhz_tlast),
    .m_axis_adap_tx_322mhz_tuser_err          (axis_adap_tx_322mhz_tuser_err),
    .m_axis_adap_tx_322mhz_tready             (axis_adap_tx_322mhz_tready),

    .s_axis_adap_rx_322mhz_tvalid             (axis_adap_rx_322mhz_tvalid),
    .s_axis_adap_rx_322mhz_tdata              (axis_adap_rx_322mhz_tdata),
    .s_axis_adap_rx_322mhz_tkeep              (axis_adap_rx_322mhz_tkeep),
    .s_axis_adap_rx_322mhz_tlast              (axis_adap_rx_322mhz_tlast),
    .s_axis_adap_rx_322mhz_tuser_err          (axis_adap_rx_322mhz_tuser_err),
