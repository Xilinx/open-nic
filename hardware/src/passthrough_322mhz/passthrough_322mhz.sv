...
module passthrough_322mhz #(
  ...
  generate for (genvar i = 0; i < NUM_CMAC_PORT; i++) begin
    axi_stream_register_slice #(
      ...
      .s_axis_tvalid (s_axis_adpt_tx_322mhz_tvalid[i]),
      .s_axis_tdata  (s_axis_adpt_tx_322mhz_tdata[`getvec(512, i)]),
      .s_axis_tkeep  (s_axis_adpt_tx_322mhz_tkeep[`getvec(64, i)]),
      .s_axis_tlast  (s_axis_adpt_tx_322mhz_tlast[i]),
      .s_axis_tid    (0),
      .s_axis_tdest  (0),
      .s_axis_tuser  (s_axis_adpt_tx_322mhz_tuser_err[i]),
      .s_axis_tready (s_axis_adpt_tx_322mhz_tready[i]),

      .m_axis_tvalid (m_axis_cmac_tx_322mhz_tvalid[i]),
      .m_axis_tdata  (m_axis_cmac_tx_322mhz_tdata[`getvec(512, i)]),
      .m_axis_tkeep  (m_axis_cmac_tx_322mhz_tkeep[`getvec(64, i)]),
      .m_axis_tlast  (m_axis_cmac_tx_322mhz_tlast[i]),
      .m_axis_tid    (),
      .m_axis_tdest  (),
      .m_axis_tuser  (m_axis_cmac_tx_322mhz_tuser_err[i]),
      .m_axis_tready (m_axis_cmac_tx_322mhz_tready[i]),
    ...
    axi_stream_register_slice #(
      ...
      .s_axis_tvalid (s_axis_cmac_rx_322mhz_tvalid[i]),
      .s_axis_tdata  (s_axis_cmac_rx_322mhz_tdata[`getvec(512, i)]),
      .s_axis_tkeep  (s_axis_cmac_rx_322mhz_tkeep[`getvec(64, i)]),
      .s_axis_tlast  (s_axis_cmac_rx_322mhz_tlast[i]),
      .s_axis_tid    (0),
      .s_axis_tdest  (0),
      .s_axis_tuser  (s_axis_cmac_rx_322mhz_tuser_err[i]),
      .s_axis_tready (),

      .m_axis_tvalid (m_axis_adpt_rx_322mhz_tvalid[i]),
      .m_axis_tdata  (m_axis_adpt_rx_322mhz_tdata[`getvec(512, i)]),
      .m_axis_tkeep  (m_axis_adpt_rx_322mhz_tkeep[`getvec(64, i)]),
      .m_axis_tlast  (m_axis_adpt_rx_322mhz_tlast[i]),
      .m_axis_tid    (),
      .m_axis_tdest  (),
      .m_axis_tuser  (m_axis_adpt_rx_322mhz_tuser_err[i]),
      .m_axis_tready (1'b1),
